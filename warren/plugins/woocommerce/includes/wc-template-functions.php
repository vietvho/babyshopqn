...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
		...
		echo '<span class="c-carousel-product-list__product-btn">'.__('Xem thêm').'</span>';
	}
}
...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		echo '<a href="javascript:void(0)" class="c-carousel-product-list__product woocommerce-LoopProduct-link woocommerce-loop-product__link product-quickview" data-id="'.get_the_ID().'">';
	}
}
...
if ( ! function_exists( 'woocommerce_template_loop_product_thumbnail' ) ) {
	...
	function woocommerce_template_loop_product_thumbnail() {
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo "<div class='c-carousel-product-list__product-thumb'>";
		echo woocommerce_get_product_thumbnail();
		echo '<span class="c-carousel-product-list__product-btn_view">'.__('Xem nhanh').'</span>';
		echo "</div>";
	}
}

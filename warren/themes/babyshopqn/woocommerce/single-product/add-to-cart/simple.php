...
if ( $product->is_in_stock() ) : ?>
	...
	<div class="add_cart_area">
		...
		<form class="cart add-to-cart-custom" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>

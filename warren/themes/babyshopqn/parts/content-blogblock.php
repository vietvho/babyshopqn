...
<div class="c-carousel-product-list__product-thumb">
   <?php 
	$_img_placeholder = '<img src="data:image/svg+xml,%3Csvg%20xmlns=\'https://www.w3.org/2000/svg\'%20viewBox=\'0%200%200%200\'%3E%3C/svg%3E"  data-src="'. woocommerce_placeholder_img_src() . '" alt="product placeholder Image" class="lazy-img card-img-top" width="65px" height="115px" />';
   	if (has_post_thumbnail( $post->ID )) {
		...
		if(!empty($_url)) {
    		$_img_placeholder = '<img src="data:image/svg+xml,%3Csvg%20xmlns=\'https://www.w3.org/2000/svg\'%20viewBox=\'0%200%200%200\'%3E%3C/svg%3E"  data-src="'. $_url . '" alt="Placeholder" data-alt="' . $_alt . '" class="lazy-img card-img-top" />'; 
		}
   	} 
